...
exit();
    ...
    $query="Select Precio from Articulos where CodArt='9';";
...
<?php if (!isset($_POST["img"])) : ?>
                    ...
                    <button class="button" type="submit" name="img" value="9"  style="cursor:pointer">
                        <h4>RAQUETA DE TENIS<br>BABOLAT</h4> 
                        <p><?php echo $precio ?> €</p> 
                        <br>   
                        <img src="fotos/9.jpg" width="135">
                        </button>
                        <div >
