          ...
          <?php if (!isset($_POST["usuario"])) : ?>
            ...
            <form role="form" method="post" enctype="multipart/form-data">
                          ...
                          <?php
                            ...
                            if ($result = $connection->query($query)) {
                                while($obj = $result->fetch_object()) {
                                    ...
                                    echo "<option value=".$obj->CodArt.">".$obj->Nombre." ".$obj->Marca."</option>";
                                }
                            }
                          ?>
              ...
              <div class="form-group row">
                  ...
                  <label for="display_name" class="col-lg-2 col-form-label "><h6 >Cantidad</h6></label>
  
                      <div class="col-lg-6 text-left mt-3">
  
                      <input type="number" class="form-control mt-3" name="cantidad" placeholder>
